...
(function($) {
    $.imageArea = function(parent, id) {
        var options = parent.options,
            ...
            updateBtDelete = function (visible) {
                if ($btDelete) {
                    ...
                    $btComment.css({
                        ...
                        top: area.y - $btComment.outerHeight() - 1,
                        "z-index": area.z + 1
                    });
                }
            },
            ...
            commentSelection = function (obj) {
                $(obj[0]).css("background", "green");
                $(obj[0]).attr("data-selection-id", id);
                //console.log(obj[0].data("selection-id", 1));
            },
        ...
        if (options.allowDelete) {
            ...
            //var bindToComment = function ($obj) {
            //    $obj.click(commentSelection)
            //        .bind("touchstart", commentSelection)
            //        .bind("tap", commentSelection);
            //    return $obj;
            //};
        ...
        var bindToComment = function ($obj) {
            $obj.click(commentSelection($obj))
                .bind("touchstart", commentSelection($obj))
                .bind("tap", commentSelection($obj));
            //$obj.data("selection-id") = id;
            return $obj;
        };

        $btComment = bindToComment($("<div class=\"comment-area\" />")).append(bindToComment($("<div class=\"comment-btn\" />"))).insertAfter($btDelete);
